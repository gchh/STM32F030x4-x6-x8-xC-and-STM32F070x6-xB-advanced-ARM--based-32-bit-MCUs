...
![](https://i.imgur.com/lMabOTI.png)  
![](https://i.imgur.com/f2HhoPT.png)  

#####APB外设时钟使能寄存器2（RCC_APB2ENR）  
![](https://i.imgur.com/dD3YLiS.png)  
![](https://i.imgur.com/VlCDDLW.png)  
![](https://i.imgur.com/e3XN8rf.png)  

#####APB外设时钟使能寄存器1（RCC_APB1ENR）  
![](https://i.imgur.com/v8efKwg.png)  
![](https://i.imgur.com/Pw1iIXb.png)  
![](https://i.imgur.com/qlrYBEC.png)  

#####RTC域控制寄存器（RCC_BDCR）  
![](https://i.imgur.com/0Hx1EJY.png)  
![](https://i.imgur.com/j6Cw3t1.png)  

#####控制/状态寄存器（RCC_CSR）  
![](https://i.imgur.com/m1iBtnT.png)  
![](https://i.imgur.com/7GpyWqQ.png)  

#####AHB外设复位寄存器（RCC_AHBRSTR）  
![](https://i.imgur.com/b0Tq9yP.png)  
![](https://i.imgur.com/M4UU1b0.png)  

#####时钟配置寄存器2（RCC_CFGR2）  
![](https://i.imgur.com/HY7IXHK.png)  

#####时钟配置寄存器3（RCC_CFGR3）  
![](https://i.imgur.com/JT3pWCf.png)  

#####时钟控制寄存器2（RCC_CR2）  
![](https://i.imgur.com/pcdmupb.png)   
![](https://i.imgur.com/hbqo63M.png)  

###RCC寄存器map  
![](https://i.imgur.com/9huIt0G.png)  
![](https://i.imgur.com/IXOPiMZ.png)  
